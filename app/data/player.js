...
class Player{
    ...
    static fromDatasetJSONObject(playerId,jsonObject){
        ...
        let value2=player.value;
        let numero=value2.charAt(value2.length-1);
       let resultado=0;
        

        if (numero==="M") {
            let sinString=value2.substring(1,value2.length-1);
             resultado=sinString*1000000;
            console.log(resultado);
            
            
        }else if (numero==="K"){
            let sinString=value2.substring(1,value2.length-1);
            resultado=sinString*1000;
             console.log(resultado);

        }

         player.value=resultado;
